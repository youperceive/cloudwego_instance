...
const (
	...
	RegisterType_PHONE RegisterType = 2
)

func (p RegisterType) String() string {
	switch p {
	case RegisterType_EMAIL:
		return "EMAIL"
	case RegisterType_PHONE:
		return "PHONE"
	}
	return "<UNSET>"
}

func RegisterTypeFromString(s string) (RegisterType, error) {
	switch s {
	case "EMAIL":
		return RegisterType_EMAIL, nil
	case "PHONE":
		return RegisterType_PHONE, nil
	}
	return RegisterType(0), fmt.Errorf("not a valid RegisterType string")
}

func RegisterTypePtr(v RegisterType) *RegisterType { return &v }
func (p *RegisterType) Scan(value interface{}) (err error) {
	var result sql.NullInt64
	err = result.Scan(value)
	*p = RegisterType(result.Int64)
	return
}

func (p *RegisterType) Value() (driver.Value, error) {
	if p == nil {
		return nil, nil
	}
	return int64(*p), nil
...
type RegisterRequest struct {
	...
	RegisterType RegisterType `thrift:"register_type,3" frugal:"3,default,RegisterType" json:"register_type"`
...
func (p *RegisterRequest) GetRegisterType() (v RegisterType) {
	return p.RegisterType
}
...
func (p *RegisterRequest) SetRegisterType(val RegisterType) {
	p.RegisterType = val
}
